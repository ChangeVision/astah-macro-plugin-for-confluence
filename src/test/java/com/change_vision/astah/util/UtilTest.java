...
public class UtilTest {
	...
	@Test
	public void fileExtensionShouldReturnfileExtensionOnlyWhenFileNameHaveExtension() throws Exception {
		File file = mockFile("test.txt");
		assertThat(util.getFileExtension(file),is("txt"));		
	}
	
	@Test
	public void fileExtensionShouldReturnBakfileExtensionOnlyWhenFileNameHaveExtension() throws Exception {
	...
	@Test
	public void FilenameShouldReturnBakfileExtensionOnlyWhenFileNameHaveExtension() throws Exception {
		File file = mockFile("test.txt.bak");
	...
	public void relativePathShouldReturnEmptyWhenTheSamePath() throws Exception {
		String relativePath = util.getRelativePath(folder.getRoot().getAbsolutePath(), folder.getRoot());
		assertThat(relativePath,is(""));
	}
	
	@Test
	public void relativePathShouldReturnFileNameWhenTheFileIsUnderTheRoot() throws Exception {
		String relativePath = util.getRelativePath(folder.getRoot().getAbsolutePath(), folder.newFile("test.txt"));
		assertThat(relativePath,is("test.txt"));
	}

	@Test
	public void relativePathShouldReturnFileNameWhenTheDirIsUnderTheRoot() throws Exception {
		String relativePath = util.getRelativePath(folder.getRoot().getAbsolutePath(), folder.newFolder("test"));
